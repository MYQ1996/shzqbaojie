jQuery.effects || function (t, e) {
    ...
    t.effects = {
        ...
        function (e, n) {
            ...
            function o(t) {
                ...
                return t = t.toLowerCase(), g(c, function (e, a) {
                    var s, i = a.re.exec(t),
                        u = i && a.parse(i),
                        c = a.space || "rgba";
                    return u ? (s = r[c](u), r[l[c].cache] = s[l[c].cache], o = r._rgba = s._rgba, !1) : n
                }), o.length ? ("0,0,0,0" === o.join() && e.extend(o, s.transparent), r) : s[t]
            }

            function a(t, e, n) {
                return n = (n + 1) % 1, 1 > 6 * n ? t + 6 * (e - t) * n : 1 > 2 * n ? e : 2 > 3 * n ? t + 6 * (e - t) * (2 / 3 - n) : t
            }
            var s, i = "backgroundColor borderBottomColor borderLeftColor borderRightColor borderTopColor color columnRuleColor outlineColor textDecorationColor textEmphasisColor".split(" "),
                u = /^([\-+])=\s*(\d+\.?\d*)/,
                c = [{
                ...
                p = e("<p>")[0],
                g = e.each;
            p.style.cssText = "background-color:rgba(1,1,1,.5)", h.rgba = p.style.backgroundColor.indexOf("rgba") > -1, g(l, function (t, e) {
                ...
                parse: function (a, i, u, c) {
                    if (a === n) return this._rgba = [null, null, null, null], this;
                    (a.jquery || a.nodeType) && (a = e(a).css(i), i = n);
                    var d = this,
                        h = e.type(a),
                        p = this._rgba = [];
                    return i !== n && (a = [a, i, u, c], h = "array"), "string" === h ? this.parse(o(a) || s._default) : "array" === h ? (g(l.rgba.props, function (t, e) {
                        p[e.idx] = r(a[e.idx], e)
                    }), this) : "object" === h ? (a instanceof f ? g(l, function (t, e) {
                        a[e.cache] && (d[e.cache] = a[e.cache].slice())
                    }) : g(l, function (e, n) {
                        var o = n.cache;
                ...
                is: function (t) {
                    var e = f(t),
                        r = !0,
                        o = this;
                    return g(l, function (t, a) {
                        var s, i = e[a.cache];
                        return i && (s = o[a.cache] || a.to && a.to(o._rgba) || [], g(a.props, function (t, e) {
                            return null != i[e.idx] ? r = i[e.idx] === s[e.idx] : n
                        })), r
                    }), r
                },
                _space: function () {
                ...
                transition: function (t, e) {
                    var n = f(t),
                        ...
                        u = i.slice();
                    return n = n[a.cache], g(a.props, function (t, o) {
                        var a = o.idx,
                            s = i[a],
                            c = n[a],
                            f = d[o.type] || {};
                        null !== c && (null === s ? u[a] = c : (f.mod && (c - s > f.mod / 2 ? s += f.mod : s - c > f.mod / 2 && (s -= f.mod)), u[a] = r((c - s) * e + s, o)))
                    }), this[o](u)
                },
                blend: function (t) {
                ...
                toHexString: function (t) {
                    var n = this._rgba.slice(),
                        r = n.pop();
                    return t && n.push(~~(255 * r)), "#" + e.map(n, function (t) {
            ...
            }), f.fn.parse.prototype = f.fn, l.hsla.to = function (t) {
                ...
                var e, n, r = t[0] / 255,
                    ...
                    f = i + u,
                    l = .5 * f;
                return e = u === i ? 0 : r === i ? 60 * (o - a) / c + 360 : o === i ? 60 * (a - r) / c + 120 : 60 * (r - o) / c + 240, n = 0 === l || 1 === l ? l : .5 >= l ? c / f : c / (2 - f), [Math.round(e) % 360, n, l, null == s ? 1 : s]
                ...
                var e = t[0] / 360,
                    ...
                    s = .5 >= r ? r * (1 + n) : r + n - r * n,
                    i = 2 * r - s;
                return [Math.round(255 * a(i, s, e + 1 / 3)), Math.round(255 * a(i, s, e)), Math.round(255 * a(i, s, e - 1 / 3)), o]
            }, g(l, function (t, o) {
                var a = o.props,
                    s = o.cache,
                    i = o.to,
                    c = o.from;
                f.fn[t] = function (t) {
                    if (i && !this[s] && (this[s] = i(this._rgba)), t === n) return this[s].slice();
                    var o, u = e.type(t),
                        l = "array" === u || "object" === u ? t : arguments,
                        d = this[s].slice();
                    return g(a, function (t, e) {
                        var n = l["object" === u ? t : e.idx];
                        null == n && (n = d[e.idx]), d[e.idx] = r(n, e)
                    }), c ? (o = f(c(d)), o[s] = d, o) : f(d)
                }, g(a, function (n, r) {
                    f.fn[n] || (f.fn[n] = function (o) {
                        var a, s = e.type(o),
                            i = "alpha" === n ? this._hsla ? "hsla" : "rgba" : t,
                            c = this[i](),
                            f = c[r.idx];
                        return "undefined" === s ? f : ("function" === s && (o = o.call(this, f), s = e.type(o)), null == o && r.empty ? this : ("string" === s && (a = u.exec(o), a && (o = f + parseFloat(a[2]) * ("+" === a[1] ? 1 : -1))), c[r.idx] = o, this[i](c)))
                    })
                })
            }), g(i, function (t, n) {
                e.cssHooks[n] = {
                    set: function (t, r) {
                        var a, s, i = "";
                        if ("string" !== e.type(r) || (a = o(r))) {
                            if (r = f(a || r), !h.rgba && 1 !== r._rgba[3]) {
                                for (s = "backgroundColor" === n ? t.parentNode : t;
                                    ("" === i || "transparent" === i) && s && s.style;) try {
                                    i = e.css(s, "backgroundColor"), s = s.parentNode
                                } catch (u) {}
        ...
        function () {
            function n() {
                var e, n, r = this.ownerDocument.defaultView ? this.ownerDocument.defaultView.getComputedStyle(this, null) : this.currentStyle,
                    o = {};
                if (r && r.length && r[0] && r[r[0]])
                    for (n = r.length; n--;) e = r[n], "string" == typeof r[e] && (o[t.camelCase(e)] = r[e]);
                else
            ...
            function r(e, n) {
                var r, o, s = {};
                for (r in n) o = n[r], e[r] !== o && (a[r] || (t.fx.step[r] || !isNaN(parseFloat(o))) && (s[r] = o));
                return s
            }
            ...
            t.each(["borderLeftStyle", "borderRightStyle", "borderBottomStyle", "borderTopStyle"], function (e, n) {
            ...
            }), t.effects.animateClass = function (e, a, s, i) {
                var u = t.speed(a, s, i);
                return this.queue(function () {
                    var a, s = t(this),
                        i = s.attr("class") || "",
                        c = u.children ? s.find("*").andSelf() : s;
                    c = c.map(function () {
                        var e = t(this);
                        return {
                            el: e,
                    ...
                    }), s.attr("class", i), c = c.map(function () {
                        var e = this,
                            n = t.Deferred(),
                            r = jQuery.extend({}, u, {
                                queue: !1,
                ...
                addClass: function (e, n, r, o) {
                    return n ? t.effects.animateClass.call(this, {
                        add: e
                    }, n, r, o) : this._addClass(e)
                },
                _removeClass: t.fn.removeClass,
                removeClass: function (e, n, r, o) {
                    return n ? t.effects.animateClass.call(this, {
                        remove: e
                    }, n, r, o) : this._removeClass(e)
                },
                _toggleClass: t.fn.toggleClass,
                toggleClass: function (n, r, o, a, s) {
                    return "boolean" == typeof r || r === e ? o ? t.effects.animateClass.call(this, r ? {
                        add: n
                    } : {
                        remove: n
                    }, o, a, s) : this._toggleClass(n, r) : t.effects.animateClass.call(this, {
                        toggle: n
                    }, r, o, a)
                },
        ...
        function () {
            ...
            function a(e) {
                return !e || "number" == typeof e || t.fx.speeds[e] ? !0 : "string" != typeof e || t.effects.effect[e] ? !1 : n && t.effects[e] ? !1 : !0
            }
            t.extend(t.effects, {
                version: "1.9.2",
                save: function (t, e) {
                    for (var n = 0; e.length > n; n++) null !== e[n] && t.data(r + e[n], t[0].style[e[n]])
                },
                restore: function (t, n) {
                    var o, a;
                    for (a = 0; n.length > a; a++) null !== n[a] && (o = t.data(r + n[a]), o === e && (o = ""), t.css(n[a], o))
                },
                ...
                effect: function () {
                    function e(e) {
                        ...
                        var o = t(this),
                            a = r.complete,
                            s = r.mode;
                        (o.is(":hidden") ? "hide" === s : "show" === s) ? n(): i.call(o[0], r, n)
                    }
                    var r = o.apply(this, arguments),
                        a = r.mode,
                        s = r.queue,
                        i = t.effects.effect[r.effect],
                        u = !i && n && t.effects[r.effect];
                    return t.fx.off || !i && !u ? a ? this[a](r.duration, r.complete) : this.each(function () {
                        r.complete && r.complete.call(this)
                    }) : i ? s === !1 ? this.each(e) : this.queue(s || "fx", e) : u.call(this, {
                        options: r,
                        duration: r.duration,
                        callback: r.complete,
                        mode: r.mode
