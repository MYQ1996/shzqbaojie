function lisclick(t) {
    var a = $(t).text(),
        i = $(t).attr("data-value");
    isshow = !0, $(".measure input").val(a), $('input[name="housearea"]').val(i), $(".measurelist").hide()
}
...
function citylisclick(t) {
    ...
    var a = $(t).text(),
        i = $(t).attr("data-value");
    isshow = !0, $(".measure2 input").val(a), $('input[name="city"]').val(i), $(".measurelist2").hide()
}
$(function () {
    function t(t) {
        var a = t.className.split(" ");
        for (var i in a)
            if ("hiring" == a[i]) return !0;
        return !1
    }
    ...
    navigator.userAgent.indexOf("UCBrowser") > -1 && $(".uc").focus(function () {
        ...
        e.show(), i.toggleClass("close"), e.toggleClass("on"), "menu close" == $(this).attr("class") ? (l = !0, document.addEventListener("touchmove", function (t) {
    ...
    $(window).scroll(function () {
        ...
        t(this) && ($(this).addClass("on"), b.removeClass("on")), l = !0;
        var a = $(this).attr("data-val");
        39 == a && window.screen.width <= 750 && $("#phoneHtml").hide();
        $(window).width();
        $(".serviceurl").attr("src", s[a - 1]), $(".cengbox").show(), document.addEventListener("touchmove", function (t) {
            l && (t.preventDefault(), t.stopPropagation())
        })
    }), n.click(function () {
        $("#phoneHtml").show(), $(".cengbox").hide(), $(".serviceurl").attr("src", ""), l = !1, $("html,body").removeClass("ovfHiden"), h.removeClass("on"), b.addClass("on")
    });
    var r = function () {
            $.ajax({
                type: "GET",
    ...
    p(), r(), d(), y(), $(".say").click(function () {
        m.show(), a() || $("[placeholder]").focus(function () {
            var t = $(this);
        ...
        var t = $(this).index();
        $(this).addClass("on").siblings().removeClass("on"), $(".righttext div").eq(t).show().siblings().hide()
    }), $(".aboutnav li").click(function () {
        var t = $(this).index();
        $(this).addClass("on").siblings("ul li").removeClass("on"), $(".tabbox>div").eq(t).show().siblings().hide(), 0 != t && $(window).width() <= 750 ? ($(".phonebanner").hide(), $(".tabbox>div").css("margin-top", "2.3rem")) : 0 == t && $(window).width() >= 750 && ($(".phonebanner").show(), $(".tabbox>div").css("margin-top", "0rem"))
    }), $(".phonemedia li").click(function () {
        var t = $(this).index();
        $(this).addClass("on").siblings().removeClass("on"), $(".mediabox>div").eq(t).show().siblings().hide()
    }), $(".postlist li").click(function () {
        var t = $(this).index();
        $(this).addClass("on").siblings().removeClass("on"), $(".postinfor").show(), $(".postinfor .infors").eq(t).show().siblings(".infors").hide(), $(".postinfor .infors").eq(t).is(":visible") && (l = !0, document.addEventListener("touchmove", function (t) {
            l && (t.preventDefault(), t.stopPropagation())
        }))
    }), $(".abclose").click(function () {
        $(this).parents(".infors").hide(), $(".postinfor").hide(), l = !1
    ...
    var _ = location.hash,
        f = $(".tabbox>div"),
        g = $(".aboutnav li");
    "#history" == _ && (f.eq(1).show().siblings().hide(), g.eq(1).addClass("on").siblings().removeClass("on")), "#media" == _ && (f.eq(2).show().siblings().hide(), g.eq(2).addClass("on").siblings().removeClass("on")), "#addour" == _ && (f.eq(4).show().siblings().hide(), g.eq(4).addClass("on").siblings().removeClass("on"))
});